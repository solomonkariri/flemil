...
import com.flemil.ui.component.List;
/**
 * Interface that a callback class has to implement in order to be able to be notified when 
 * a selection action is performed on a List for which the implementation of this interface is set
...
public interface ListSelectionListener {
	/**
	 * Called then a selection action is performed on the List for which an implementation of 
	 * this interface is registered as the receiver of selection events
	 * @param source the List on which the selection has occurred
	 */
